...
const LINES: Record<Form, Record<LineKind, string[]>> = {
  choten: {
    ...
    mp_start: [
      ...
      '라운드 1, 개시~!! 집중집중! 천사쨩이 응원할게♡',
      '드디어 시작이야~!! 파이팅!! 천사쨩도 두근두근♡',
    ],
    mp_round: [
      '다음 라운드~!! 분발해봐!♡',
      '새 문제 출제! 이번엔 꼭 먼저 맞혀~!♡',
    ...
    mp_correct: [
      '정답~!! 역시 우리 P!!! 천사쨩 감동받았어♡♡',
      '이겼다이겼다~!!! 이번 라운드 완전 우리 거야!!♡',
      '완벽해~!! 역시 최고야!! 천사쨩이 젤 좋아해♡',
    ],
    mp_rival_correct: [
    ...
    mp_win: [
      '우우승~!!!!♡♡ 최고야 최고!! 천사쨩이 젤 좋아하는 결과야~!!♡',
      '1등이다~!! 박수박수박수!!♡♡♡ 역시 P 천재라니까!!',
      '퀴즈왕 등극~!! 이 기쁨 천사쨩이랑 나눠~!!♡',
    ],
    mp_rank: [
      '고생했어~ 다음엔 더 잘할 수 있을 거야! 천사쨩이 믿어♡',
      '아쉬웠지만 재밌었지?♡ 다음엔 반드시 우승하자!',
      '오늘은 졌지만 천사쨩이랑 다음에 또 하자, 응?♡',
    ],
    mp_allgiveup: [
